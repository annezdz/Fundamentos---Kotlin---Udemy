...
fun hasIngredient(list: List<Ingredientes>, name : String) : Boolean {
...
//    data.filter { it.calorias > 500 }.map {Pair(it.nome, it.calorias) }.forEach {
//        println("${it.first} : ${it.second} calorias. ")
